...
|`rolcreaterexthdfs`|bool| |Role may create readable external tables that use the gphdfs protocol \(deprecated\).|
|rolcreatewexthdfs|bool| |Role may create writable external tables that use the gphdfs protocol \(deprecated\).|
